       ...
       <div class="container">
        <div class="row">
          <div class="col-md-8 col-sm-6 col-xs-12">
            ...
            <p style="font-weight:bold; margin-right:-450px;font-color:red;margin-top:20px;"class="copyright-text">Copyright &copy; 2021 All Rights Reserved by assets@yourservice pvt. ltd.
