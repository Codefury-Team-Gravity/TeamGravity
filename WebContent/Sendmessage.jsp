...
<body>
  ...
  <img src="logo.jpeg" width="50" height="50" style="margin-top:3px;margin-left:3px;">
  <a style="margin-right:10px; padding-right:480px;">asset@yourservice</a>
	...
	<div class="split left">
		<div class="centered">
			<img src="back2.jpeg" alt="USER" style="left: 40%;">
		</div>
	...
	<div class="split right">
		...
		<form method="post" action="send" align="center">
			...
			<br> <br> <input type="submit" value="Send" style="font-size:20px;color:blue;"> <br>
			<br>
		</form>
...
<br> <br>
		<form align="center">
			<input type="button" value="Back to Home"
				onclick="location.href = 'AdminHome.jsp';"  style=font-size:20px;color:blue;"/>
		</form>
