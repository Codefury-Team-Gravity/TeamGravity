...
.right::after {
  content: "";
  background-image: url("addassets.jpg");
...
<div class="topnav" style="color:white; font-size:20">
  ...
  <img src="bg.jpg" width="50" height="54" style="margin-top:3px;margin-left:3px;">
		<a style="margin-right:540px">asset@yourservice</a>
  </div>

<div class="split left">
  <div class="centered">
    <img src="user.jpg" alt="USER" style="left: 60%; width:100px; height:100px; margin-top:30px";">
  </div>
  <br><br><br><br>
  <div class="left" align="left">
  <table class="lefttable" style="font-size:25px;">
...
<form method = "post" action = "addasset">
					...
					<tr>
						<td></td>
						<td>
						<a href="AddNewCategory.jsp">Click to add new category...</a>
						</td>
					</tr>
...
<b><input type= submit value="Add Asset" style="color:blue; background-color:yellow"><b>
</div>
</form>
</div>
