...
<body>
  ...
  <img src="log.jpeg" width="40" height="40" style="margin-top:3px;margin-left:3px;">
  ...
  <a href="logout" class="logoutbtn"><b>Logout<b></a> 
	...
	<div class="split left">
		<div class="centered">
			<img src="existinglogo.jpg" alt="USER" style="left: 40%;">
		</div>
	...
	<div class="split right">
        ...
        <div class="row">
          <div class="col-md-8 col-sm-6 col-xs-12">
            <p class="copyright-text">Copyright &copy; 2021 All Rights Reserved by Assets @ your Service.
            </p>
          </div>
