...
public class AddAssetServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		asset.setName(request.getParameter("name"));//change "subcategory" to "name"
		asset.setAssetType(request.getParameter("type"));//change "category" to "type"
		...
		} catch (AssetAlreadyPresentException e) {
